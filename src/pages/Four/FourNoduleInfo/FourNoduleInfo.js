...
import './FourNoduleInfo.scss'
import { Select, Button } from 'antd'

const { Option } = Select

const FourNoduleInfo = props => {
      ...
      {props.noduleInfo ? (
        <div className="nodule-info">
          ...
          <div className="list">
            ...
            <Select size="small" value={props.noduleInfo.type} style={{ width: 185, fontSize: 13 }} onChange={handleSelectChange}>
            ...
            {props.noduleInfo.state !== 1 ? (
              <div className="group-wrap">
                ...
                <div className="group">
                  ...
                  <Button type={props.noduleInfo.state === 3 ? 'primary' : null} size="small" onClick={e => props.updateNoduleList(3)}>
                    恶
                  </Button>
                </div>
              </div>
